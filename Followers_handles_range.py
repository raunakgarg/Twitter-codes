...
api.followers_ids
users = tweepy.Cursor(api.followers, screen_name="PramodkumarTriv").items()
temp = []
while True:
    try:
        user = next(users)
...
dataset.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter.csv")
...
os.makedirs("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv", exist_ok=True) 
dataset2.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter1.csv")
...
dataset3.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter2.csv")
...
dataset4.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter3.csv")
...
dataset5.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter4.csv")
...
dataset6.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter5.csv")
...
dataset7.to_csv("C:\\Users\\gargrau.corpdom\\Desktop\\python_by_ganeshan\\Twitter codes\\PramodkumarTriv\\twitter6.csv")
